...
title(paste("Paired T test mean p value =",  round(mean(t.inv$P_val, na.rm = T), 5),
            ...
            ", mean t stat =", round(mean(t.inv$t.stat, na.rm = T), 5),
...
title(paste("Paired T test mean p value =",  round(mean(beta.t$P_val, na.rm = T), 5),
            ...
            ", mean t stat =", round(mean(beta.t$t.stat, na.rm = T), 5),
...
writeLines(t.inv.means, "Statistical_summaries/Sup_Fig_1a_tests.txt")
...
writeLines(beta.t.means, "Statistical_summaries/Sup_Fig_1b_tests.txt")
