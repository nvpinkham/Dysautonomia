...
map.1 <- get.close2(map.otu, 111, 45)
map.1$Age.Bin <- 111

map.2 <- get.close2(map.otu, 201, 45)
map.2$Age.Bin <- 201

map.3 <- get.close2(map.otu, 291, 45)
map.3$Age.Bin <- 291
...
res$DPW <- res$DPW + (as.numeric(res$dis) * 10) - 15
