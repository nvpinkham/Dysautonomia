...
title(paste("Paired T test mean p value =",  round(mean(shared.t$P_val), 5), "\ndf = ",
            paste(unique(shared.t$df), collapse = " "),
            "\nmean of the differences", round(mean(shared.t$effect_size), 5)))
